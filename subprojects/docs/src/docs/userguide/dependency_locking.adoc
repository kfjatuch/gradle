...
Combined with <<publishing_maven.adoc#publishing_maven:resolved_dependencies,publishing resolved versions>>, you can also hide the declared dynamic version part at publication.
And consumers will instead see the versions that your release resolved.
